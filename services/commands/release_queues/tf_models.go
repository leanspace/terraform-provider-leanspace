...
func (x *ReleaseQueue) ToTF() any {
	return &ReleaseQueueTF{
		...
		CommandTransformerPluginConfigurationData: helper.TFStringPtrValue(x.CommandTransformerPluginConfigurationData),
...
func (tf *ReleaseQueueTF) ToAPI() any {
	return &ReleaseQueue{
		...
		CommandTransformerPluginConfigurationData: helper.FromTFStringPtr(tf.CommandTransformerPluginConfigurationData),
