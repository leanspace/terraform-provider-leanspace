...
type RequestDefinition struct {
	...
	ConfigurationArgumentDefinitions []activity_definitions.Argument[any] `json:"configurationArgumentDefinitions,omitempty"`
...
type FeasibilityConstraintDefinition struct {
	...
	ArgumentDefinitions []activity_definitions.Argument[any] `json:"argumentDefinitions,omitempty"`
	CreatedAt           string                               `json:"createdAt"`
	CreatedBy           string                               `json:"createdBy"`
	LastModifiedAt      string                               `json:"lastModifiedAt"`
	LastModifiedBy      string                               `json:"lastModifiedBy"`
