...
func (plugin *Plugin) PostCreateProcess(_ *asset.Client, destPluginRaw any) error {
	return plugin.persistFilePath(destPluginRaw.(*Plugin))
}
func (plugin *Plugin) PostUpdateProcess(_ *asset.Client, destPluginRaw any) error {
	return plugin.persistFilePath(destPluginRaw.(*Plugin))
}
func (plugin *Plugin) PostReadProcess(_ *asset.Client, destPluginRaw any) error {
	return plugin.persistFilePath(destPluginRaw.(*Plugin))
}
