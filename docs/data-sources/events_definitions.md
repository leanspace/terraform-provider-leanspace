---
page_title: "leanspace_events_definitions Data Source - terraform-provider-leanspace"
subcategory: ""
description: |-
  
---

# leanspace_events_definitions (Data Source)
...
- `comparison_value` (List of Object) (see [below for nested schema](#nestedobjatt--content--rules--comparison_value))
- `operator` (String)
- `path` (String)

<a id="nestedobjatt--content--rules--comparison_value"></a>
### Nested Schema for `content.rules.comparison_value`
