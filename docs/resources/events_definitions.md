...
- `name` (String)
- `source` (String) it must be one of these values: COMMAND_STATE_CHANGED, MONITOR_TRIGGERED, PASS_AOS, PASS_LOS, STREAM_DECODED, CUSTOM, FILE_UPLOADED, RELEASE_QUEUE_COMMAND_ENQUEUED
